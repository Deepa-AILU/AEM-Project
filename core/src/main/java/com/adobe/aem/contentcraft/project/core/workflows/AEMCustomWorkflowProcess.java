package com.adobe.aem.contentcraft.project.core.workflows;
...
public class AEMCustomWorkflowProcess implements WorkflowProcess {

    private static final Logger log = LoggerFactory.getLogger(AEMCustomWorkflowProcess.class);
